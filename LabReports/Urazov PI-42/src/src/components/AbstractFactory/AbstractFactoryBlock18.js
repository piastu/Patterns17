...
export default class AbstractFactoryBlock18 extends IAbstractFactoryBlock {
    createColorBlock(colorRGB, colorH) {
        return <ColorBlock color={[colorRGB,colorH]} width={18}/>;
        // return <div
        //     style={{
    ...
    createGradientToTransparentBlock(colorRGB, colorH) {
        return <TransparentBlock color={[colorRGB,colorH]} width={18}/>;
        // return <div
        //     style={{
        //         display: 'inline-block',
        //         width: 18,
